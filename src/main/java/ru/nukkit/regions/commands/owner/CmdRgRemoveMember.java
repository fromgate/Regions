...
@CmdDefine(command = "region", alias = "rg", subCommands = {"removemember|remmember|remmem|rm", "\\S+", "\\S+"}, defaultPerm = Permission.DEFAULT_TRUE, allowConsole = true, permission = "regions.removemember", description = Message.RG_REMMEM_DESC)
