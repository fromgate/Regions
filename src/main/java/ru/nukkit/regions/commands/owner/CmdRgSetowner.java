...
@CmdDefine(command = "region", alias = "rg", subCommands = {"setowner|setown|so", "\\S+"}, allowConsole = true, defaultPerm = Permission.DEFAULT_TRUE, permission = "regions.setowner", description = Message.RG_SETOWN_DESC)
