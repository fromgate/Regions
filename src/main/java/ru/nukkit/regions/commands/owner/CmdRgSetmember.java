...
@CmdDefine(command = "region", alias = "rg", subCommands = {"setmember|setmem|sm", "\\S+"}, defaultPerm = Permission.DEFAULT_TRUE, allowConsole = true, permission = "regions.setmember", description = Message.RG_SETMBMR_DESC)
