...
@CmdDefine(command = "region", alias = "rg", subCommands = {"removeowner|remowner|remown|ro", "\\S+", "\\S+"}, defaultPerm = Permission.DEFAULT_TRUE, allowConsole = true, permission = "regions.removeowner", description = Message.RG_REMOWN_DESC)
