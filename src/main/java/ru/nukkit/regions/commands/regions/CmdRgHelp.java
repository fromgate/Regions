...
@CmdDefine(command = "region", alias = "rg", subCommands = "help|hlp|\\?", permission = "regions.help", defaultPerm = Permission.DEFAULT_TRUE, description = Message.RG_HELP_DESC, allowConsole = true)
