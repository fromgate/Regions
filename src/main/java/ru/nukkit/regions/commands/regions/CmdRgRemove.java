...
@CmdDefine(command = "region", alias = "rg", subCommands = {"remove|rem|delete|del", "\\S+"}, allowConsole = true, defaultPerm = Permission.DEFAULT_TRUE, permission = "regions.remove", description = Message.RG_REMOVE_DESC)
