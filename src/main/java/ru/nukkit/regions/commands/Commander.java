...
import ru.nukkit.regions.commands.builder.CmdBiome;
import ru.nukkit.regions.commands.builder.CmdBox;
import ru.nukkit.regions.commands.builder.CmdBrush;
import ru.nukkit.regions.commands.builder.CmdCopy;
import ru.nukkit.regions.commands.builder.CmdPaste;
import ru.nukkit.regions.commands.builder.CmdReplace;
import ru.nukkit.regions.commands.builder.CmdSet;
import ru.nukkit.regions.commands.builder.CmdUndo;
import ru.nukkit.regions.commands.builder.CmdUp;
import ru.nukkit.regions.commands.builder.CmdWalls;
import ru.nukkit.regions.commands.owner.CmdRgAddmember;
import ru.nukkit.regions.commands.owner.CmdRgAddowner;
import ru.nukkit.regions.commands.owner.CmdRgRemoveMember;
import ru.nukkit.regions.commands.owner.CmdRgRemoveOwner;
import ru.nukkit.regions.commands.owner.CmdRgSetmember;
import ru.nukkit.regions.commands.owner.CmdRgSetowner;
import ru.nukkit.regions.commands.regions.CmdClaim;
import ru.nukkit.regions.commands.regions.CmdRgDefine;
import ru.nukkit.regions.commands.regions.CmdRgFlag;
import ru.nukkit.regions.commands.regions.CmdRgHelp;
import ru.nukkit.regions.commands.regions.CmdRgInfo;
import ru.nukkit.regions.commands.regions.CmdRgInfoId;
import ru.nukkit.regions.commands.regions.CmdRgList;
import ru.nukkit.regions.commands.regions.CmdRgRedefine;
import ru.nukkit.regions.commands.regions.CmdRgReload;
import ru.nukkit.regions.commands.regions.CmdRgRemove;
import ru.nukkit.regions.commands.regions.CmdRgSelect;
import ru.nukkit.regions.commands.select.CmdChunk;
import ru.nukkit.regions.commands.select.CmdExpand;
